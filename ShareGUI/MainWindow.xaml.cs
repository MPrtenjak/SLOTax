...
namespace MNet.SLOTaxGuiTest
{
  public partial class MainWindow : Window, INotifyPropertyChanged
  {
    ...
    private void init()
    {
      ...
      this.FursEndPoints.Add(new Tuple<string, string>("Začasna Produkcija / Temporary production (https://blagajne.fu.gov.si:9009/v1/cash_registers)", @"https://blagajne.fu.gov.si:9009/v1/cash_registers"));
